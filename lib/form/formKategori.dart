...
class FormKategoriScreen extends StatefulWidget {
  ...
  @override
  _FormKategoriScreenState createState() => _FormKategoriScreenState();
}
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      icon: Icon(Icons.person), labelText: 'Name kategori'),
                ),
                Padding(
                ...
                TextField(
                  ...
                  style:
                      TextStyle(fontSize: 17.0, color: Colors.deepOrangeAccent),
                  decoration: InputDecoration(
                      icon: Icon(Icons.list), labelText: 'Description kategori'),
                ),
                Padding(
                  padding: EdgeInsets.only(top: 8.0),
                ),
